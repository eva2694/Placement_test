I checked the code and removed the line `blob_data.close()`, which was placed incorrectly. It was trying to close the blob data stream immediately after opening it, preventing further operations on the stream. Here is the correct code:
